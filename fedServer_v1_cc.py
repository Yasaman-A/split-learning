...
logging.basicConfig(filename="./cc_fed_server_" + sys.argv[1] + "_" + sys.argv[2] + "_" + sys.argv[3] + ".log",
...
def main():
    ...
    for r in range(num_rounds):
        ...
        model_save_name = "./cc_client_fedAvg_model_r" + str(r) + "_" + sys.argv[1] + "_" + sys.argv[2] + "_" + sys.argv[3] + ".pt"
