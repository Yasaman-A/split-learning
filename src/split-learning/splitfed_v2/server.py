    ...
    def run(self):
        ...
        def main():
            ...
            for r in range(num_rounds):
                ...
                accuracy = eval_step(arch, server_global_weights, fed_socket, device, self.config, "Validation", r)
                ...
                eval_step(arch, server_global_weights, fed_socket, device, self.config, "testing", r)
